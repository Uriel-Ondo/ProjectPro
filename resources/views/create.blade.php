...
@section('contenu')
 <body class="mt-4, mb-4">
    ...
    @endif
          <form style="width: 80%, center, left:15%;" class="table table-bordered table-hover mt-3;" method="POST" action="{{route('ajouter')}}">
              @csrf
              <div class="mb-3">
              ...
              <a href="{{route('welcome')}}" class="btn btn-danger , mb-4, mt-1">Annuler</a>
            </form>
