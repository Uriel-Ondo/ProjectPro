...
<meta name="theme-color" content="#712cf9">
  ...
  <body class="d-flex h-100 text-center text-bg-dark">
    ...
    <div class="dropdown position-fixed  bd-mode-toggle">
...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-auto">
    <div>
      ...
      <h3  class="float-md-start mb-0">ProjectPro</h3>
      </a>
      <nav class="nav nav-masthead justify-content-center float-md-end">
        <a class="nav-link fw-bold py-1 px-1 active" aria-current="page" href="{{route('welcome')}}">Acceuil</a>
        <a class="nav-link fw-bold py-1 px-1" href="{{route('dashboard')}}">Tableau de bord</a>
        <a class="nav-link fw-bold py-1 px-1" href="{{ route('profile.show') }}"> Profil</a>
      </nav>
    </div>
  </header>
